...
function EditForm({allUserData, setAllUserData}) {
    ...
    const [editFormData, setEditFormData] = useState({
        bet: relevantBet.description,
        odds: relevantBet.odds,
        league: relevantBet.league,
        result: relevantBet.result,
        unitsChange: relevantBet.units_change,
        betType: relevantBet.bet_type,
    ...
    function editBet(editedBet) {
        const editedUserData = [editedBet,...allUserData]
    ...
    return (
        <div className="editForm">
            ...
            <form onSubmit={handleSubmit}>
                <label>Bet</label>
                <input id="bet" type="text" name="bet" value={editFormData.bet} onChange={handleChange}></input>
                <label>Odds</label>
                ...
                <input id="unitsChange" type="text" name="units_change" value={editFormData.unitsChange} onChange={handleChange}></input>
                <label>Type of Bet</label>
                <input id="betType" type="text" name="betType" value={editFormData.betType} onChange={handleChange}></input>
                <label>Segment</label>
